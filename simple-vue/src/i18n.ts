...
const messages = {
  'en-US': {
    ...
    pwa: { install: 'Install app', backToTop: 'Back to top', unavailable: 'Installation is unavailable in this browser', installed: 'DuoZhiGame installed', guideTitle: 'Add to Home Screen', close: 'Close', safariShare: "Tap Safari's Share button", safariAdd: 'Choose "Add to Home Screen"', chromeShare: "Tap Chrome's Share button", chromeAdd: 'Choose "Add to Home Screen" from the menu', confirm: 'Tap "Add" to finish', guideNote: 'After installation, open DuoZhiGame from your Home Screen.' },
  },
  'zh-CN': {
    step: '步骤 {number}',
    home: 'DuoZhiGame 首页', categories: '游戏分类', providers: '游戏厂商', language: '语言', openTelegram: '打开 Telegram', search: '搜索游戏', featuredGames: '精选游戏', featured: '精选', playNow: '启动', playFeatured: '进入精选游戏 {name}', play: '进入游戏 {name}', gameCount: '{count} 款游戏', gamesTitle: '{brand} 游戏', games: '游戏', loadingGames: '正在加载游戏', providerUnavailable: '厂商数据暂不可用', tryAgain: '重试', gamesLoadFailed: '游戏加载失败', noGames: '未找到游戏', noGamesHint: '请尝试其他关键词或厂商。',
  ...
  'ja-JP': {
    ...
    pwa: { install: 'アプリをインストール', backToTop: 'トップへ戻る', unavailable: 'このブラウザでは直接インストールできません', installed: 'DuoZhiGameをインストールしました', guideTitle: 'ホーム画面に追加', close: '閉じる', safariShare: 'Safariの共有ボタンをタップ', safariAdd: '「ホーム画面に追加」を選択', chromeShare: 'Chromeの共有ボタンをタップ', chromeAdd: 'メニューから「ホーム画面に追加」を選択', confirm: '「追加」をタップして完了', guideNote: 'インストール後、ホーム画面からDuoZhiGameを開いてください。' },
  },
  'ko-KR': {
    step: '단계 {number}',
    home: 'DuoZhiGame 홈', categories: '게임 카테고리', providers: '게임 제공사', language: '언어', openTelegram: 'Telegram 열기', search: '게임 검색', featuredGames: '추천 게임', featured: '추천', playNow: '지금 플레이', playFeatured: '추천 게임 {name} 플레이', play: '{name} 플레이', gameCount: '게임 {count}개', gamesTitle: '{brand} 게임', games: '게임', loadingGames: '게임 불러오는 중', providerUnavailable: '제공사 데이터를 사용할 수 없습니다', tryAgain: '다시 시도', gamesLoadFailed: '게임을 불러올 수 없습니다', noGames: '게임을 찾을 수 없습니다', noGamesHint: '다른 검색어나 제공사를 선택해 보세요.',
  ...
  'th-TH': {
    ...
    pwa: { install: 'ติดตั้งแอป', backToTop: 'กลับด้านบน', unavailable: 'เบราว์เซอร์นี้ยังไม่รองรับการติดตั้งโดยตรง', installed: 'ติดตั้ง DuoZhiGame แล้ว', guideTitle: 'เพิ่มไปยังหน้าจอโฮม', close: 'ปิด', safariShare: 'แตะปุ่มแชร์ของ Safari', safariAdd: 'เลือก “เพิ่มไปยังหน้าจอโฮม”', chromeShare: 'แตะปุ่มแชร์ของ Chrome', chromeAdd: 'เลือก “เพิ่มไปยังหน้าจอโฮม” จากเมนู', confirm: 'แตะ “เพิ่ม” เพื่อเสร็จสิ้น', guideNote: 'หลังติดตั้ง ให้เปิด DuoZhiGame จากหน้าจอโฮม' },
  },
  'id-ID': {
    step: 'Langkah {number}',
    home: 'Beranda DuoZhiGame', categories: 'Kategori game', providers: 'Penyedia game', language: 'Bahasa', openTelegram: 'Buka Telegram', search: 'Cari game', featuredGames: 'Game unggulan', featured: 'UNGGULAN', playNow: 'Main sekarang', playFeatured: 'Mainkan game unggulan {name}', play: 'Mainkan {name}', gameCount: '{count} game', gamesTitle: 'Game {brand}', games: 'Game', loadingGames: 'Memuat game', providerUnavailable: 'Data penyedia tidak tersedia', tryAgain: 'Coba lagi', gamesLoadFailed: 'Game tidak dapat dimuat', noGames: 'Game tidak ditemukan', noGamesHint: 'Coba pencarian atau penyedia lain.',
  ...
  'bn-BD': {
    ...
    pwa: { install: 'অ্যাপ ইনস্টল করুন', backToTop: 'উপরে ফিরুন', unavailable: 'এই ব্রাউজারে সরাসরি ইনস্টল করা যাচ্ছে না', installed: 'DuoZhiGame ইনস্টল হয়েছে', guideTitle: 'হোম স্ক্রিনে যোগ করুন', close: 'বন্ধ করুন', safariShare: 'Safari-এর শেয়ার বোতামে ট্যাপ করুন', safariAdd: '“হোম স্ক্রিনে যোগ করুন” নির্বাচন করুন', chromeShare: 'Chrome-এর শেয়ার বোতামে ট্যাপ করুন', chromeAdd: 'মেনু থেকে “হোম স্ক্রিনে যোগ করুন” নির্বাচন করুন', confirm: 'শেষ করতে “যোগ করুন” ট্যাপ করুন', guideNote: 'ইনস্টলের পর হোম স্ক্রিন থেকে DuoZhiGame খুলুন।' },
  },
}

export const i18n = createI18n({
  legacy: false,
  locale: localStorage.getItem('duozhi-language') || 'en-US',
