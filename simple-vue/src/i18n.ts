...
const messages = {
  ...
  'zh-CN': {
    recharge: { title: '充值', credit: '到账金额', pay: '请准确支付', estimate: '预估支付数量（不含识别尾数）', create: '创建订单', refresh: '刷新', newOrder: '新建订单', expires: '到期时间', network: '仅限 TRON 主网。请按所选币种和完整数量转账，手续费另付。', failed: '请求失败', pending: '等待付款', paid: '已到账', expired: '订单已过期，如已付款请等待核验，勿重复转账。', review: '付款核验中', closed: '已关闭' },
    step: '步骤 {number}',
